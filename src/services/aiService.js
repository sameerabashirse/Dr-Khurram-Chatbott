...
function t(language, key, params = {}) {
  ...
  const strings = {
    en: {
      ...
      booked: "Appointment confirmed with Meta delivery pending. Appointment ID: {id}, Token: {token}, Date: {date}, Time: {time}. Clinic contact: +92 335 7504478.",
      ...
      cancelled: "Appointment {id} has been cancelled. Clinic contact: +92 335 7504478.",
      ...
      location: "The clinic address has not been verified yet. Please contact the clinic at +92 335 7504478.",
      doctor: "Dr. Khurram's specialty, qualifications, experience, biography, and clinic address are editable staff settings and are not verified yet. Contact: +92 335 7504478.",
      ...
      optedOut: "You have been opted out of non-essential messages. You can still contact the clinic at +92 335 7504478."
    },
    "roman-ur": {
      ...
      booked: "Appointment confirm ho gayi hai; Meta delivery pending hai. Appointment ID: {id}, Token: {token}, Date: {date}, Time: {time}. Clinic contact: +92 335 7504478.",
      lookupAsk: "Apna Appointment ID bhejein.",
      lookupResult: "Appointment ID: {id}\nToken: {token}\nPatient: {name}\nDate: {date}\nTime: {time}\nStatus: {status}\nReminder status: {reminder}",
      cancelConfirm: "Appointment {id} cancel karne ke liye CONFIRM CANCEL reply karein.",
      cancelled: "Appointment {id} cancel ho gayi hai. Clinic contact: +92 335 7504478.",
      ...
      location: "Clinic address abhi verify nahi hua. Please clinic se contact karein: +92 335 7504478.",
      doctor: "Dr. Khurram ki specialty, qualifications, experience, biography aur clinic address staff settings mein editable hain aur abhi verified nahi. Contact: +92 335 7504478.",
      ...
      optedOut: "Aap non-essential messages se opt out ho gaye hain. Clinic contact: +92 335 7504478."
    },
    ur: {
